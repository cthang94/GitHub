...
# purpose of 3 is to read a list and create a dictionary with color name as key and hex value as the value
...
def partThree():
    ...
    emptyList = ['White', 'FFFFFF', 'Whitesmoke', 'F5F5F5', 'Snow', 'FFFAFA', 'Ghostwhite', 'F8F8FF', 'Floralwhite', 'FFFAF0']
    # create a dictionary
    dictionary = dict()
    counter = 0
